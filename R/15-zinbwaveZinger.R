...
#' @param parameters A object generated by \code{\link[zinbwaveZingercollected]{NBsimSingleCell}}
#' @param return_format A character. Alternatives choices: list, SingleCellExperiment,
#' Seurat, h5ad
#' @param verbose Logical. Whether to return messages or not.
#' @param seed A random seed.
#'
#' @importFrom zinbwaveZingercollected NBsimSingleCell
...
zinbwaveZinger_simulation <- function(ref_data,
  ...
  simulate_formals <- simutils::change_parameters(function_expr = "zinbwaveZingercollected::NBsimSingleCell",
                                                  other_prior = other_prior,
                                                  step = "simulation")
  # Return to users
