...
Lun2_simulation <- function(parameters,
  ...
  # Return to users
  cat(glue::glue("Your simulated datasets will have {params_check[['nCells']]} cells, {params_check[['nGenes']]} genes, {params_check[['nPlates']]} plate(s) and contain {params_check[['de.nGenes']]/params_check[['nGenes']]} percent of DEGs"), "\n")
  ##############################################################################
  ####                            Simulation                                 ###
  ##############################################################################
  if(verbose){
