...
#' using `SPARSim_estimate_parameter_from_data` function in SPARSim package.
#'
...
SPARSim_estimation <- function(ref_data,
  ...
  estimate_formals <- simutils::change_parameters(
    function_expr = "SPARSim::SPARSim_estimate_parameter_from_data",
  ...
  ##############################################################################
  if(verbose){
    message("Estimating parameters using SPARSim")
  }
  # Seed
  set.seed(seed)
  # Estimation
...
#'
#' This function is used to simulate datasets from learned parameters by `SPARSim_simulation`
