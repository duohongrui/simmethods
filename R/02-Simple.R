...
#' using `simpleEstimate` function in Splatter package.
#'
...
Simple_estimation <- function(ref_data,
  ...
  ##############################################################################
  if(verbose){
    message("Estimating parameters using Simple")
  }
  # Seed
  set.seed(seed)
  # Estimation
...
#'
#' This function is used to simulate datasets from learned parameters by `simpleSimulate`
#' function in Splatter package.
#'
#' @param parameters A object generated by [splatter::simpleEstimate()]
...
#' @importFrom splatter simpleSimulate
#' @details
...
#' simulate_result <- Simple_simulation(parameters = estimate_result[["estimate_result"]],
#'                                      return_format = "list",
#'                                      verbose = TRUE,
#'                                      seed = 111)
...
Simple_simulation <- function(parameters,
  ...
  ##############################################################################
  if(verbose){
    message("Simulating datasets using Simple")
  }
  # Seed
